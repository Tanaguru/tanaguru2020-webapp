...
import IconOrganize from './icons/IconOrganize'
...
import IconVersion from './icons/IconVersion'
import IconCompliant from './icons/IconCompliant'
import IconIgnored from './icons/IconIgnored'
import IconImproper from './icons/IconImproper'
import IconInforound from './icons/IconInforound'
import IconNotApplicable from './icons/IconNotApplicable'
import IconQualify from './icons/IconQualify'
import IconUntested from './icons/IconUntested'
import IconAuditPage from './icons/IconAuditPage'
import IconAuditSite from './icons/IconAuditSite'
import IconAuditScenario from './icons/IconAuditScenario'
import IconAuditAssisted from './icons/IconAuditAssisted'
import IconAuditFile from './icons/IconAuditFile'
